<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"G:\phpStudy\PHPTutorial\WWW\TP5\public/../application/admin\view\article\add.html";i:1535426226;s:70:"G:\phpStudy\PHPTutorial\WWW\TP5\application\admin\view\common\top.html";i:1535440660;s:71:"G:\phpStudy\PHPTutorial\WWW\TP5\application\admin\view\common\left.html";i:1535356660;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('links/lst'); ?>">文章管理</a>
                    </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="cateid" id="cateid">
                                    ...
                                    <option value="<?php echo $vo['cateid']; ?>" ><?php echo $vo['catename']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label>
                                    <input class="checkbox-slider colored-darkorange" id="state" name="state" value="true" type="checkbox"><!--checked="checked"默认开启-->
